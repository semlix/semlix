...
from semlix import analysis, fields, formats, highlight, qparser, query
from semlix.codec.whoosh3 import W3Codec
from semlix.compat import u, xrange, text_type, permutations
from semlix.filedb.filestore import RamStorage
from semlix.util.testing import TempStorage, TempIndex
...
def test_closed_searcher():
    from semlix.reading import ReaderClosed
