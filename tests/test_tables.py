...
from semlix.compat import b, xrange, iteritems
from semlix.filedb.filestore import RamStorage
from semlix.filedb.filetables import HashReader, HashWriter
from semlix.filedb.filetables import OrderedHashWriter, OrderedHashReader
...
def test_checksum_file():
    from semlix.filedb.structfile import ChecksumFile
