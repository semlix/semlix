...
The ``limitmb`` parameter to :meth:`semlix.index.Index.writer` controls the
...
.. note::
    ...
    but not for trying to exactly control the memory usage of semlix.


The ``procs`` parameter
=======================

The ``procs`` parameter to :meth:`semlix.index.Index.writer` controls the
